...
mongoose.connect("mongodb+srv://nishadb84:anshu@cluster0.n96uh0l.mongodb.net/e-commerce");
...
app.post("/upload", upload.single('product'), (req, res) => {
    res.json({
        ...
        image_url: `https://shopplusplusbk.onrender.com/images/${req.file.filename}`
    })
})
...
app.post('/addtocart',fetchuser, async (req, res) => {
  console.log("AddedCart",req.body.itemId);
